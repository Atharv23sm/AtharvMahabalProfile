...
function About({ scroll }) {
    ...
    return (
        <div className="w-full h-full flex flex-col items-center gap-8" id="about">
            <div className={`info_title text-[22vw] mt-20 md:mt-0`}>ABOUT</div>
            <div className={`info_container p-3 md:-mt-[13.2vw] border-t border-l md:border-0 space-y-6 pb-0 ${scroll >= 500 ? 'translate-y-0' : 'translate-y-[10vw]'}`}>
